<header>
  <div class="container b-header__box b-relative">
        <a href="/" class="b-left b-logo ">
            {!! Html::image('assets/frontend/img/logo-header-default.png','Logo',array('class'=>'color-theme' ,'data-retina' => 'data-retina')) !!}
        </a>
                            ...
                            <li>
                                <div class="b-option-cart__items__img">
                                    <div class="view view-sixth">
                                        {!! Html::image('assets/frontend/img/shop/cart_mini_pic.jpg','',array('data-retina' => '')) !!}
